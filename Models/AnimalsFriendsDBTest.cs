...
{
    public class AnimalsFriendsDBTest : DropCreateDatabaseIfModelChanges<AnimalsFriendsContext>
    {
        protected override void Seed(AnimalsFriends.Models.AnimalsFriendsContext context)
        {
