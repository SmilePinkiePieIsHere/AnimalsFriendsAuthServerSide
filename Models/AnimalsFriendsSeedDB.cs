...
namespace AnimalsFriends.Models
{
    ...
    {
        public static void Seed(AnimalsFriendsContext context)
        {
            context.Users.AddRange(
                new User { Username = "danitza@example.com", Password = "12345" },
                new User { Username = "niya@example.com", Password = "12345" });
