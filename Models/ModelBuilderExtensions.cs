    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Animal>().HasData(
               ...
               new Animal { Id = Guid.Parse("b35c7f05-4c59-49e9-9688-8ea8c44d6eed"), UserId = "4f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Буря", Gender = Helpers.Classes.Gender.Female, CurrentStatus = Helpers.Classes.AnimalStatus.NeedHome, Description = "Сладък котарак! Оранжева фурия!", Species = Helpers.Classes.AnimalSpecies.Cat, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Burq.jpg") },
               new Animal { Id = Guid.Parse("c2ef263f-efd4-46ce-b512-1152f316971d"), UserId = "4f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Елмо", Gender = Helpers.Classes.Gender.Male, CurrentStatus = Helpers.Classes.AnimalStatus.Adopted, Description = "Елмо вече се радва на всекиднвени разходки с новото си семейство!", Species = Helpers.Classes.AnimalSpecies.Dog, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Elmo.jpg") },
               new Animal { Id = Guid.Parse("797dff10-6c5f-40ae-9a06-0845e17f8ed0"), UserId = "4f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Ласи", Gender = Helpers.Classes.Gender.Male, CurrentStatus = Helpers.Classes.AnimalStatus.NeedHome, Description = "Пухест и добър!", Species = Helpers.Classes.AnimalSpecies.Dog, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Lasi.jpg") },
               new Animal { Id = Guid.Parse("5d5102df-bee0-4588-b2ed-ae149b1211f8"), UserId = "5f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Пипин", Gender = Helpers.Classes.Gender.Male, CurrentStatus = Helpers.Classes.AnimalStatus.NeedHome, Description = "Госпожа Саня е на около 6 години.", Species = Helpers.Classes.AnimalSpecies.Cat, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Pipin.jpg") },
               new Animal { Id = Guid.Parse("ee193bc8-b139-400d-a5bd-a414bf2255dc"), UserId = "5f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Саня", Gender = Helpers.Classes.Gender.Female, CurrentStatus = Helpers.Classes.AnimalStatus.InMedicalCare, Description = "Оранжева фурия!", Species = Helpers.Classes.AnimalSpecies.Cat, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Sanq.jpg") },
               new Animal { Id = Guid.Parse("a798f9ba-3cb9-4046-8e8b-71aef6ccdbf4"), UserId = "5f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Сняг", Gender = Helpers.Classes.Gender.Male, CurrentStatus = Helpers.Classes.AnimalStatus.Adopted, Description = "Сняг е на около 8 месеца, кротък и поспалив. Търси своите хора!", Species = Helpers.Classes.AnimalSpecies.Dog, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Snqg.jpg") },
               new Animal { Id = Guid.Parse("1189ab7c-c7cc-4390-ac5a-35c1d7564ce4"), UserId = "5f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Томи", Gender = Helpers.Classes.Gender.Male, CurrentStatus = Helpers.Classes.AnimalStatus.Adopted, Description = "Томи вече се привиква на новия си начин на живот - заобиколен от своите любящи нови стопани!", Species = Helpers.Classes.AnimalSpecies.Dog, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Tommy.jpg") },
               new Animal { Id = Guid.Parse("1a4ef056-8274-41d4-a978-f39f908ba688"), UserId = "5f6183ea-100e-4e78-ad26-14b7de22e571", Name = "Бистра", Gender = Helpers.Classes.Gender.Female, CurrentStatus = Helpers.Classes.AnimalStatus.InMedicalCare, Description = "Малката Бистра беше намерена със счупен крак (най-вероятно блъсната от кола), но вече се възстановява!", Species = Helpers.Classes.AnimalSpecies.Dog, ProfileImg = ConvertImageToBase64("\\Resources\\images\\thumbnails\\Bistra.jpg") });

            modelBuilder.Entity<Post>().HasData(
                new Post { Id = Guid.Parse("560d8317-2ddc-4f49-8ed5-09419957ab6f"), UserId = "4f6183ea-100e-4e78-ad26-14b7de22e571", Title = "Баба Марта идва!", Category = Helpers.Classes.BlogCategory.Causes },
                new Post { Id = Guid.Parse("afec3793-fd53-4f39-a3b6-7d453ab39105"), UserId = "4f6183ea-100e-4e78-ad26-14b7de22e571", Title = "Великденски яйца!", Category = Helpers.Classes.BlogCategory.News },
